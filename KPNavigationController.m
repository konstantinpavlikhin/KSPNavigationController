...
- (void) insertNavViewController: (KPNavViewController*) newController
{
  ...
  NSView* newNavigationBarItem = [newController rightNavigationBarView];
...
{
  KPNavViewController* currentController = [self topViewController];
  
  [[currentController rightNavigationBarView] removeFromSuperviewWithoutNeedingDisplay];
